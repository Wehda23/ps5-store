...
const SignIn = () => {
  ...
  const handleResetPassword = (e) => {
    ...
    if (!resetEmail) {
      ...
      setResetMsg(`If ${resetEmail} is registered, you will receive an email to reset your password.`);
      setResetEmail("");
    }
  };
        ...
        <div className="w-[450px] h-full bg-primeColor px-10 flex flex-col gap-6 justify-center">
          ...
          <div className="w-[300px] flex items-start gap-3">
            ...
            <p className="text-base text-gray-300">
              ...
              <br />
              When you sign in, you become part of our community! Quick-start your journey with PS5-Store.
            </p>
          </div>
          <div className="w-[300px] flex items-start gap-3">
            <span className="text-green-500 mt-1">
            ...
            <p className="text-base text-gray-300">
              ...
              <br />
              Discover a world of gaming with ease. Our selection is curated for the passionate gamer in you
            </p>
          </div>
          <div className="w-[300px] flex items-start gap-3">
            <span className="text-green-500 mt-1">
            ...
            <p className="text-base text-gray-300">
              ...
              <br />
              Join the ranks of satisfied gamers who've found their home for PlayStation 5 essentials.
            </p>
          </div>
          ...
          <form className="w-full lgl:w-[450px] h-screen flex items-center justify-center">
            <div className="px-6 py-4 w-full h-[90%] flex flex-col justify-center overflow-y-scroll scrollbar-thin scrollbar-thumb-primeColor">
              ...
              <div className="flex flex-col gap-3">
                ...
                {resetMsg && (
                  <p className="text-sm text-green-500 font-titleFont font-semibold px-4 mt-2">
                    {resetMsg}
                  </p>
                )}
